...
INSERT INTO `bank` VALUES (1,'ALLIANCE BANK'),(3,'AMBANK COMPANY'),(4,'ARGO'),(5,'ARGO COMPANY'),(6,'BSN'),(7,'BSN COMPANY'),(8,'CIMB'),(9,'CIMB COMPANY'),(10,'CIMB COMPANY TNG+DUITNOW'),(11,'CIMB CREDIT CARD'),(12,'HLB'),(13,'HLB COMPANY'),(14,'HLB CREDIT CARD'),(15,'MBB'),(16,'MBB COMPANY'),(17,'MBB TNG'),(18,'PBB'),(19,'PBB COMPANY'),(20,'RHB'),(21,'RHB COMPANY'),(22,'UOB COMPANY'),(24,'abc');
...
CREATE TABLE `card` (
  ...
  `reject_remarks` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `cased_by` int DEFAULT NULL,
  `cased_at` date DEFAULT NULL,
  `case_remarks` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
INSERT INTO `card` VALUES (1,20,'RHB card','111111','online_user_id','online_password','atm_password','account_no','otp_no','111','address_of_bank','secure_word','gmail_of_bank',NULL,NULL,NULL,316666.67,'Approved',1,'2023-04-28',NULL,NULL,NULL,NULL,NULL,NULL,1,'2023-04-28'),(2,3,'Am Card','121212','online_user_id','online_password','atm_password','account_no','otp_no','1212','address_of_bank','secure_word','gmail_of_bank',NULL,NULL,NULL,316666.67,'Approved',1,'2023-04-28',NULL,NULL,NULL,NULL,NULL,'c',1,'2023-04-28'),(8,3,'Name 4','IC 4','Online User ID 4','Online Password 4','Atm Password 4','Account No 4','OTP No 4','Card No/Company ID 4','Address of Bank 4','Secure word 4','Gmail of Bank 4','Home Address 4','Mother Name 4','Company Name 4',69.00,'Approved',1,'2023-05-03',1,'2023-05-03','Here are some Reject Remarks!',1,'2023-05-03','Here are some Case Remarks!',1,'2023-05-08'),(9,1,'TESTING Name','123456-71-8901','ABC123','OnlinePassword','AtmPassword','A123456B','123456','123-123-123','No 111, Jalan 111, Taman 111.','SecureWord','Gmail@Bank.com','No 222, Jalan 222, Taman 222.','Tan Ah Mei','XYZ Company',1.00,'Approved',1,'2023-05-05',NULL,NULL,NULL,NULL,NULL,NULL,1,'2023-05-12'),(10,1,'Hun','012345678901','123','1234','12345','123456','1234567','12345678','123456789','1234567891','12345678912','No 333, Jalan 333, Taman 333,','Han','Com',666.00,'Approved',1,'2023-05-11',NULL,NULL,NULL,NULL,NULL,NULL,1,'2023-05-11');
...
INSERT INTO `invoice_no` VALUES (6,4,'2023-05-31');
...
INSERT INTO `payment` VALUES (1,'2023-04-12','2023-04-01',111.00,11),(3,'2023-05-10','2023-06-30',10.00,11);
...
CREATE TABLE `rent_card` (
  ...
  `case_remarks` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `cased_by` int DEFAULT NULL,
  `cased_at` datetime DEFAULT NULL,
  `user_id` int NOT NULL,
  `invoice_no` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
INSERT INTO `rent_card` VALUES (6,1,'2023-05-09','2023-05-19',1.00,2.00,NULL,NULL,NULL,11,'20230500004',11,0.35),(7,8,'2023-05-10','2023-05-31',3.00,4.00,'Some case remarks...',1,'2023-05-10 21:55:57',11,'20230500002',0,0.00),(8,8,'2023-05-11','2023-05-31',123.22,222.22,NULL,NULL,NULL,11,'20230500003',21,83.47),(9,2,'2023-05-12','2023-05-22',1.00,2.00,NULL,NULL,NULL,11,'20230500003',11,0.35),(10,10,'2023-05-11','2023-05-31',1.00,2.00,'TESTING: fix including cased card',1,'2023-05-11 23:54:12',11,NULL,21,0.68);
/*!40000 ALTER TABLE `rent_card` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-05-12 19:20:12
