...
<div class="content-wrapper">
	...
	if (isset($report) && $report == "rpt01") { ?>
		...
		<section>
			...
			<a class="btn btn-info" style="float: right; color: white;">Export to Excel</a>
			...
			if (isset($all_center))   echo '1. $all_center = ' . $all_center;   # D
			if (isset($all_center) && !empty($all_center)) {
				echo '2. $all_center = ' . $all_center;   # D

				$sql_center = "SELECT * FROM center_detail ORDER BY id ASC";
				echo '$sql_center = ' . $sql_center;   # D

				$results = mysqli_query($conn, $sql_center);
				echo '$results = ' . $results;   # D
			...
			?>
						...
						<table cellspacing="1" cellpadding="1" style="width:80%" class="table table-striped table-bordered" align="center">
							...
							<?= '$_SESSION["center_id"] = ' . $_SESSION['center_id'] ?> <!-- D -->
				...
				<table cellspacing="1" cellpadding="1" style="width:80%; margin-bottom: 0%;" class="table table-striped table-bordered" align="center">
					<caption class="menu-header">Monthly Collection Report11</caption>
					<?php if ($_SESSION['center_id'] != 5) { ?>
						<!-- PREV VERS START -->
						<!-- <thead>
							<tr>
				...
				<div style="width: 80%; height: 500px; overflow: auto; margin-left: auto; margin-right: auto;" class="table table-striped table-bordered"> <!-- OPT: width: 500px, margin-left: 50px, border: 1px solid; -->
					<table id="tbl_exporttable_to_xls" class="freeze-table" width="700px">
						...
						<thead>
							<tr>
								...
								<th style="min-width: 100px; width:100px;" class="col-second-name fixed-header">Phone</td>
									<!-- <td>Day</td> --> <!-- ????? -->
								<th style="min-width: 50px; width:50px;">1</th>
								<th style="min-width: 50px; width:50px;">2</th>
								<th style="min-width: 50px; width:50px;">3</th>
								<th style="min-width: 50px; width:50px;">4</th>
								<th style="min-width: 50px; width:50px;">5</th>
								<th style="min-width: 50px; width:50px;">6</th>
								<th style="min-width: 50px; width:50px;">7</th>
								<th style="min-width: 50px; width:50px;">8</th>
								<th style="min-width: 50px; width:50px;">9</th>
								<th style="min-width: 50px; width:50px;">10</th>
								<th style="min-width: 50px; width:50px;">11</th>
								<th style="min-width: 50px; width:50px;">12</th>
								<th style="min-width: 50px; width:50px;">13</th>
								<th style="min-width: 50px; width:50px;">14</th>
								<th style="min-width: 50px; width:50px;">15</th>
								<th style="min-width: 50px; width:50px;">16</th>
								<th style="min-width: 50px; width:50px;">17</th>
								<th style="min-width: 50px; width:50px;">18</th>
								<th style="min-width: 50px; width:50px;">19</th>
								<th style="min-width: 50px; width:50px;">20</th>
								<th style="min-width: 50px; width:50px;">31</th>
								<th style="min-width: 50px; width:50px;">32</th>
								<th style="min-width: 50px; width:50px;">33</th>
								<th style="min-width: 50px; width:50px;">34</th>
								<th style="min-width: 50px; width:50px;">35</th>
								<th style="min-width: 50px; width:50px;">36</th>
								<th style="min-width: 50px; width:50px;">37</th>
								<th style="min-width: 50px; width:50px;">38</th>
								<th style="min-width: 50px; width:50px;">39</th>
								<th style="min-width: 50px; width:50px;">30</th>
								<th style="min-width: 50px; width:50px;">31</th>
							</tr>
						</thead>
						...
						<tbody>
							...
							?>
								<tr>
									<td class="col-id-no" scope="row">35-64</td>
									<td class="col-first-name" scope="row">test user</td>
									<td class="col-second-name" scope="row">01234567890</td>
									<!-- <td>Day</td> --> <!-- ????? -->
									<td>1</td>
									<td>2</td>
									<td>3</td>
